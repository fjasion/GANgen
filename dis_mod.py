...
class DiscriminatorLayer:
    def __init__(self, prev_size, curr_size, act_f, act_f_der, learning_rate):
...
class Discriminator:
    def __init__(self, learning_rate=0.01):
        self.layers = []
        self.layers.append(DiscriminatorLayer(1, 784, sgmd, dsgmd, learning_rate))
        self.layers.append(DiscriminatorLayer(784, 64, sgmd, dsgmd, learning_rate))
        self.layers.append(DiscriminatorLayer(64, 1, sgmd, dsgmd, learning_rate))
    ...
    def backprop(self, X, expected,update=True):
        ...
        for i in range(len(self.layers)-1, 0, -1):
            self.layers[i].backprop(self.layers[i-1],update)
